...
public class World {
	...
	/** Add a Central System to get and process all host state */
	private boolean setCS = false;
	private MessageRouter cs;
	...
	private void initSettings() {
		...
		if(s.contains("setCS")) {
			this.setCS = s.getBoolean("setCS");
			this.cs = (MessageRouter)s.createIntializedObject("routing."+s.getSetting("CentralSystem"));
	...
	public void update () {
		...
		/* Central System collects and update state */
		if(this.setCS)
			this.cs.update(this.hosts);
